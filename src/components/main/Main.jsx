  ...
  return (
    <div className="flex flex-col md:flex-row bg-slate-100 dark:bg-slate-950 ">
      ...
      <section className="w-full md:w-[25%] bg-white dark:bg-slate-900/30">
        <div className="w-auto m-4 dark:bg-slate-900/90 p-4 rounded-md flex flex-col gap-2">
          <div className="dark:text-slate-400 font-semibold text-md md:text-lg pb-2">
            Ilham Rifai
          </div>
          <div className="dark:text-slate-400 font-semibold text-xs md:text-md pb-2">
            Administrator
          </div>
          <div className="text-indigo-900 font-bold text-sm md:text-md dark:text-transparent dark:bg-gradient-to-tl from-indigo-800 to-pink-800 py-2 rounded-md cursor-pointer ">
            <div className="dark:text-slate-400 text-slate-900 text-center">
              Profile
            </div>
          </div>
        </div>
